...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2025 at 04:40 AM
...
ALTER TABLE `peminjaman`
  ...
  ADD CONSTRAINT `peminjaman_ibfk_3` FOREIGN KEY (`id_petugas`) REFERENCES `petugas` (`id_petugas`) ON DELETE SET NULL;
...
ALTER TABLE `pengembalian`
  ...
  ADD CONSTRAINT `pengembalian_ibfk_2` FOREIGN KEY (`id_petugas`) REFERENCES `petugas` (`id_petugas`) ON DELETE SET NULL;
COMMIT;
